    ...
    <View style={[localStyles.container]}>
      <TouchableOpacity
        ...
        {user.photo ? (
          ...
          <View style={[localStyles.avatar, {backgroundColor: appColor.gray2}]}>
            <TextCus
              title
              size={22}
        ...
        <TextCus text={user.name} title size={18} />
      </TouchableOpacity>
      <FlatList
        ...
        renderItem={({item, index}) => (
          <RowComponent
            ...
            {item.icon}
            <TextCus text={item.title} styles={localStyles.listItemText} />
          </RowComponent>
        )}
      />
      <RowComponent justify="flex-start">
        <TouchableOpacity
          ...
          <TextCus color="#00F8FF" text="Upgrade Pro" />
        </TouchableOpacity>
      </RowComponent>
    </View>
  );
